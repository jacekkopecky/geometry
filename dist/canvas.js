...
function drawCircle(x, y, r, style = 'black') {
    c.strokeStyle = style;
    c.beginPath();
    c.ellipse(x, y, r, r, 0, 0, 7);
    c.stroke();
}
function drawPoint(x, y, style = 'black') {
...
function getPointForEventCoords(e) {
...
export function getCursorCoords(e, snap = false) {
...
export function getNearestCircle(e) {
    const point = getPointForEventCoords(e);
